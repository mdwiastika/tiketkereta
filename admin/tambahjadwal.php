                            ...
                            <form action="" method="POST">
                                <div class=" form-group">
                                    ...
                                    <select id="kategori" class="form-control" name="nama_ker" required autocomplete="off">
                                        ...
                                        <?php
                                        $query = mysqli_query($connect, "SELECT * FROM kereta");
                                        while ($data = mysqli_fetch_assoc($query)) { ?>
                                            <option value="<?php echo $data['id_ker']; ?>"><?php echo $data["nama_ker"]; ?> (<?= $data["kelas_ker"]; ?>)</option>
                                        <?php
                                        }
                                        ?>
                                    </select>
                                ...
                                <div class="form-group">
                                    <label for="deskripsi">Berangkat (waktu):</label>
                                    <input type="text" class="form-control" id="deskripsi" name="berangkat" required autocomplete="off">
                                </div>
                                <div class="form-group">
